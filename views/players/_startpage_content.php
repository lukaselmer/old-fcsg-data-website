...
<div class="player rounded">
    <div class="inner">
        ...
        <div class="fl rss" style="width: 150px; font-size: 0.8em;">
            <? include("http://local.fcsg-data.ch/lib/rss_parser/rss2html.php?XMLFILE=http://feeds.feedburner.com/fcsg%3fformat%3dxml&TEMPLATE=http://local.fcsg-data.ch/lib/rss_parser/fcsg-template.html&MAXITEMS=3"); ?>
        </div>
        <? clearer(); ?>
    </div>
</div>
