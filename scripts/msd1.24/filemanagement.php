...
switch ($action)
{
	...
	case 'restore':
		...
		echo '<input class="Formbutton" name="restore" type="submit" value="' . $lang['restore_of_tables'] . '" onclick="document.forms[0].tblfrage.value=1;">';
		echo FileList();
	...
	case "convert":
		...
		echo '<table class="bdr"><tr><th colspan="2">' . $lang['convert_title'] . '</th></tr>';
