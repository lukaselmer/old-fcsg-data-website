...
switch ($phase)
{
	...
	case 4: //Verzeichnisse
		...
		if ($iw[0] && $iw[1] && $iw[2] && $iw[3]) echo '<tr><td colspan="2">' . $lang['dirs_created'] . '<br><br><input class="Formbutton" type="Button" value=" ' . $lang['install_continue'] . ' " onclick="location.href=\'install.php?language=' . $language . '&phase=5&connstr=' . $connstr . '\'"></td></tr>';
		echo '</table></form>';
		break;
	case 5:
