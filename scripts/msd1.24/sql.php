...
if ($search == 0 && !$download)
{
	...
	if ($mode > '' && $context == 0)
	{
		...
		if ($mode == "edit" || $mode == "searchedit")
		{
			...
			$aus.='<tr><td colspan="3" align="right"><br /><input type="hidden" name="feldnamen" value="' . substr($feldnamen,0,strlen($feldnamen) - 1) . '">
					<input class="Formbutton" type="submit" name="update" value="' . $lang['save'] . '">&nbsp;&nbsp;&nbsp;
					<input class="Formbutton" type="reset" name="reset" value="' . $lang['reset'] . '">&nbsp;&nbsp;&nbsp;
					<input class="Formbutton" type="Button" value="' . $lang['cancel'] . '" onclick="location.href=\'sql.php?db=' . $db . '&amp;dbid=' . $dbid . '&amp;tablename=' . $tablename . '\';"></td></tr>';
