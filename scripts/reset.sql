...
(4, 'Blibla Blub', 'Méi et wuel alles kommen, engem grouss blénken dee as. Gét fu wait brét prächteg, ons Kaffi d''Kanner vu. Ké vill bessert vun, dem ménger Hämmel um, sech d''Beem gebotzt et bei. Spilt soubal Feierwon wat hu, drem d''Mier nozegon am wéi, mat geet Bänk dämpen un.');
